...
//     it('should sort by upvote_count when specified', async () => {
//       mockRepository.findAndCount.mockResolvedValue([[], 0]);

//       await service.findAll({ sort: 'upvoteCount', order: 'DESC' });
...
//       const savedVideo = { id: 'video-new', ...createData, upvoteCount: 0, downvoteCount: 0 };
//       mockRepository.create.mockReturnValue(savedVideo as Video);
//       mockRepository.save.mockResolvedValue(savedVideo as Video);
//       mockRepository.findOne.mockResolvedValue({ ...mockVideo, id: 'video-new' });
...
//       const videoWithoutUser = { ...mockVideo, sharedBy: undefined, sharedById: 'user-1' };
...
//       };
//       const dto = service.toResponseDto(videoWithNulls as Video, null);
